...
const Faqs = () => {
    ...
    const titles = [
        ...
        {title: '¿CÓMO PIDO UN BLINK?', desc: <p className='faqs__detail'>Pulsa <b>“PEDIR”</b> en la pantalla de inicio y busca a quién le vas a pedir el Blink por nombre o usuario. Ingresa el valor que estás pidiendo y un mensaje de texto si deseas.<br/><br/>Pulsa <b>“ACEPTAR”</b> y tu pedido se ha realizado con éxito. Si la persona acepta, recibirás un Blink por el valor pedido, si lo rechaza recibirás una notificación de que tu pedido ha sido rechazado.<br/><br/><span className='link_text' onClick={ () => {
  ...
  return (
    ...
    >
        ...
        <Modal isOpen={isOpenModal} closeModal={() => {
                ...
                <iframe className='yt_player_iframe' width="560" height="315" src={useUrl} title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture;" allowFullScreen></iframe>
        </Modal>
    </Dashed>
  )
}
